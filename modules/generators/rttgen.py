...
def e_dec(num):
        assert num in "0123456789ABCDEFGHJKLMNPQRSTUVWXYZ", str(num) + " is not a valid e_hex value"
...
def rttgen(sysname):
        ...
        find_mainworld(system_clean)
        return(system_clean)

def find_mainworld(system):
        mainworld = "X000000-0-000"
        #            0123456789ABC
        better = False
        for star in system["Stars"]:
                if system["Stars"][star] != "NA":
